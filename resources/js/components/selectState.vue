<template> 
    <div class="mx-0 px-0 row mb-3 col-md-8">
        <div class="row mb-3 col-md-6 mx-auto">
        ...
        <div class="row mb-3 col-md-6 mx-auto">
            ...
            <div class="col-md-8">
                <select id="lga" class="form-control" name="lga" autofocus>                    
                    <option v-for="(lga, index) in clgas" :selected="sellga==lga.toUpperCase()" :key="'x_'+index" :value="lga.toUpperCase()" >{{lga.toUpperCase()}}</option>
                </select>            
            </div>
        </div>
    </div>
